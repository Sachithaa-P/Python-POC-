...
import os
from poc2exception import EmptyQueryException, InvalidFileNameException, RestrictedSQLCommandException  # Importing custom exceptions
...
# Default folder path
DEFAULT_FOLDER = r"C:\Users\s.paranidharan\POC1"  # Change this to your desired folder path
...
def run_query_with_exceptions(query, file_name):
    ...
    try:
        ...
        if not query.strip():
            raise EmptyQueryException("Query cannot be empty. Please enter a valid SQL query.")
    ...
    except (EmptyQueryException, InvalidFileNameException, RestrictedSQLCommandException) as e:
        print(str(e))
